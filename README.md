...
### 8.1. Что такое Clang, и какова его роль в процессе компиляции программ?
...
### 8.2. Что представляет собой LLVM и как он используется в современных компиляторах?
...
### 8.3. Чем отличается AST от LLVM IR?
...
### 8.4. Для чего необходимо IR в процессе компиляции?
...
### 8.5. Что делает инструкция `alloca` в LLVM IR, и зачем она используется в функциях?
...
### 8.6. Зачем нужна оптимизация кода в компиляторе?
...
### 8.7. Что такое SSA-форма и почему она важна?
...
### 8.8. Что такое CFG и как он помогает анализировать программу?
...
### 8.9. Как представлены арифметические операции в LLVM IR?
...
### 8.10. Почему функции в LLVM IR обычно являются отдельными единицами анализа и оптимизации?
...
### 8.11. Что происходит с функцией в LLVM IR, если она вызывается один раз и очень короткая?
...
### 8.12. Какие преимущества дают IR и CFG по сравнению с анализом исходного текста на C?
