...
\*\*После публикации исполняемый файл находится по пути:\*\*
GUI\\bin\\Release\\net8.0-windows\\win-x64\\publish\\GUI.exe



Приложение запускается без установленной среды разработки и дополнительных библиотек.
...
!\[Меню Файл](Screenshots/file\_menu.png)
...
!\[Меню Правка](Screenshots/edit\_menu.png)
...
!\[Меню Текст](Screenshots/text\_menu.png)
...
!\[Меню Справка](Screenshots/help\_menu.png)
...
!\[Область вывода](Screenshots/output.png)
...
!\[Открытие файла](Screenshots/exm\_open.png)
